...
from candlefree.agent.factory import SYSTEM_PROMPT
from candlefree.agent.tools import (
...
# CandleFree tools (schedule, conflicts, safe slots, reschedule, notify)
tools = [
    get_loadshedding_schedule,
    find_meeting_conflicts,
    suggest_safe_slot,
...
def _extract_prompt(payload: dict):
    ...
    return prompt or DEFAULT_BACKGROUND_PROMPT
